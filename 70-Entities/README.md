...
no private personal data**. A password or token belongs in the local KeePass database, filed
with `_bin/kp.py` and referenced as a `kp://` pointer, never in the body of an entity note. Record what helps you work with
